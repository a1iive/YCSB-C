...
moreworkloads="workloads/test_workloadc.spec:workloads/test_workloadc4.spec:workloads/test_workloadc3.spec:workloads/test_workloadc2.spec:workloads/test_workloadc1.spec"
...
if [ -n "$1" ];then    #后台运行
cmd="nohup ./ycsbc -db hwdb -dbpath $dbpath -threads 1 -P $workload -load true -morerun $moreworkloads -dbstatistics true >$1 2>&1  &"
