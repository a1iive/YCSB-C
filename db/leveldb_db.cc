...
namespace ycsbc {
    ...
    int LevelDB::Read(const std::string &table, const std::string &key, const std::vector<std::string> *fields,
                      std::vector<KVPair> &result, int num) {
        string value;
    ...
    int LevelDB::Scan(const std::string &table, const std::string &key, const std::string &max_key, int len, 
                        const std::vector<std::string> *fields, std::vector<std::vector<KVPair>> &result, int num) {
    ...
    int LevelDB::Insert(const std::string &table, const std::string &key,
                        std::vector<KVPair> &values, int num){
        leveldb::Status s;
        string value;
    ...
    int LevelDB::Update(const std::string &table, const std::string &key, std::vector<KVPair> &values, int num) {
        return Insert(table,key,values,num);
    }

    int LevelDB::Delete(const std::string &table, const std::string &key, int num) {
        leveldb::Status s;
        leveldb::WriteOptions write_options = leveldb::WriteOptions();
        if(write_sync_) {
            write_options.sync = true;
